...
abstract class Renderable {
    abstract render(ctx: SuitableCanvasContext, glyphs: Map<string, string>): void;
}
...
class TypstUse extends Renderable {
    ...
    render(ctx: SuitableCanvasContext, glyphs: Map<string, string>): void {
        ...
        if (hasDefs) {
            ...
            for (const child of defs.children) {
                ...
                if (path) {
                    ...
                    this.glyphs.set(child.raw.getAttribute('id')!, d!);
                }
            }
